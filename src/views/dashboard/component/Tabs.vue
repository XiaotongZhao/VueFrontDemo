  ...
  <v-container id="panels" fluid tag="section">
    ...
    <v-row>
      <v-col cols="12" md="6">
        <v-card class="my-0">
          <v-card-text>
            <base-subheading subheading="Navigation Pills" text="Horizontal Tabs" />
              ...
              <v-tab-item>
                <v-card flat class="my-0">
                  <v-card-text>
                    ...
                    <div>Dramatically maintain clicks-and-mortar solutions without functional solutions.</div>
                  </v-card-text>
                </v-card>
              </v-tab-item>
              <v-tab-item>
                <v-card flat class="my-0">
                  <v-card-text>
                    ...
                    <div>Dynamically innovate resource-leveling customer service for state of the art customer service.</div>
                  </v-card-text>
                </v-card>
              </v-tab-item>
            </base-material-tabs>
      ...
      <v-col cols="12" md="6">
        <v-card class="mt-0">
          <v-card-text>
            <base-subheading subheading="Navigation Pills" text="Vertical Tabs" />
            <base-material-tabs color="success" vertical>
              <v-tab v-for="(tab, i) in tabs" :key="i" class="mb-1">{{ tab }}</v-tab>
              <v-tab-item>
                <v-card flat class="my-0">
          ...
          <v-card-text>
            ...
            <v-expansion-panels>
              <v-expansion-panel v-for="n in 5" :key="n">
                <v-expansion-panel-header>Collapsible Group Item #{{ n }}</v-expansion-panel-header>
                <v-expansion-panel-content>Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS.</v-expansion-panel-content>
              </v-expansion-panel>
            </v-expansion-panels>
          </v-card-text>
        </v-card>
              ...
              <v-tab-item>
                <v-card flat class="my-0">
                  <v-card-text class="pt-0">
                    <p>Collaboratively administrate empowered markets via plug-and-play networks. Dynamically procrastinate B2C users after installed base benefits.</p>
                    <p>Dramatically visualize customer directed convergence without revolutionary ROI. Collaboratively administrate empowered markets via plug-and-play networks. Dynamically procrastinate B2C users after installed base benefits.</p>
                    <div>Dramatically visualize customer directed convergence without revolutionary ROI. Collaboratively administrate empowered markets via plug-and-play networks. Dynamically procrastinate B2C users after installed base benefits.</div>
                  </v-card-text>
                </v-card>
              </v-tab-item>
              <v-tab-item>
      ...
      <v-col class="mx-auto" cols="12" md="8">
        <div class="text-center headline font-weight-light mb-12 pl-0">Page Subcategories</div>
        <base-material-tabs
          v-model="tab"
              ...
              <v-card class="mt-0 px-5">
                <v-card-text>
                  <base-subheading subheading="Description about product">
                    <p class="grey--text body-2 font-weight-light">More Information here</p>
                  </base-subheading>
                  <p>Collaboratively administrate empowered markets via plug-and-play networks. Dynamically procrastinate B2C users after installed base benefits.</p>
                  <div>Dramatically visualize customer directed convergence without revolutionary ROI. Collaboratively administrate empowered markets via plug-and-play networks. Dynamically procrastinate B2C users after installed base benefits.</div>
                </v-card-text>
            ...
            <v-tab-item>
              <v-card class="mt-0 px-5">
                <v-card-text>
                  ...
                  <div>Another Text. The first thing you notice when you hold the phone is how great it feels in your hand. The cover glass curves down around the sides to meet the anodized aluminum enclosure in a remarkable, simplified design.</div>
                </v-card-text>
              </v-card>
            </v-tab-item>
          </v-tabs-items>
...
export default class DashboardPanels extends Vue {
  ...
  private tabs: Array<String> = ["Profile", "Settings", "Options"];
  private tabs2: Array<Object> = [
    {
      text: "Home",
