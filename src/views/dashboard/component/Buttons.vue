      ...
      <v-card-text class="pt-0">
        <v-row>
          ...
          <v-col class="pt-0" cols="12" md="6">
            ...
            <div>
              <v-btn v-for="(dir, i) in ['left', 'right']" :key="i" elevation="1" class="ma-1">
                <v-icon
                  :left="dir === 'left'"
                  :right="dir === 'right'"
          ...
          <v-col cols="12" md="6">
            ...
            <v-btn
              ...
              class="ma-1"
              color="secondary"
            >{{ n === 1 ? 'small' : n === 2 ? 'regular' : 'large' }}</v-btn>
          </v-col>
          <v-col cols="12" md="6">
            <base-subheading>
            ...
            <v-btn class="ma-1" elevation="1" color="secondary" rounded>Rounded</v-btn>
            <v-btn class="ma-1" color="secondary" elevation="1" rounded>
              <v-icon left>mdi-heart</v-icon>With Icon
            </v-btn>
          ...
          <v-col cols="12" md="6">
            ...
            <v-sheet>
              <v-btn-toggle color="teal">
                <v-btn v-for="dir in ['left', 'middle', 'right']" :key="dir">{{ dir }}</v-btn>
              </v-btn-toggle>
            </v-sheet>
            <div class="my-6" />
            <v-btn-toggle color="teal" rounded>
              <v-btn v-for="n in 4" :key="n">{{ n }}</v-btn>
            </v-btn-toggle>
            <div class="my-2" />
            <v-btn-toggle color="teal" rounded>
              <v-btn v-for="n in 3" :key="n">{{ n + 4 }}</v-btn>
            </v-btn-toggle>
          </v-col>
            ...
            <v-col :key="i" cols="12" class="py-1">
              ...
              <v-row dense>
                ...
                <v-col cols="auto" md="1" sm="1">
                  <v-btn elevation="1" :color="s.color" dark min-width="0" max-width="41">
                    <v-icon v-text="s.icon" />
                  </v-btn>
                </v-col>
                <v-col cols="auto" md="1" sm="1">
                  <v-btn elevation="1" :color="s.color" dark fab min-width="0" small>
                    <v-icon v-text="s.icon" />
                  </v-btn>
                </v-col>
                <v-col cols="auto" md="1" sm="1">
...
@Component
export default class DashboardButtons extends Vue {
