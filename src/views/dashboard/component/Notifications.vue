<template>
  <v-container id="alerts" fluid tag="section">
      ...
      <v-col cols="12" md="6">
        <v-card>
          <v-card-text>
            ...
            <base-material-alert color="info" dark>This is a plain notification.</base-material-alert>
            <base-material-alert
              color="info"
              dark
              dismissible
            >This is a notification with close button.</base-material-alert>
            <base-material-alert
              color="info"
              dark
              dismissible
              icon="mdi-bell"
            >This is a notification with close button and icon and have many lines. You can see that the icon and the close button are always vertically aligned. This is a beautiful notification. So you don't have to worry about the style.</base-material-alert>
            <base-material-alert
              color="primary"
              dark
              dismissible
              icon="mdi-bell"
            >You can see that the icon and the close button are always vertically aligned. This is a beautiful notification. So you don't have to worry about the style.</base-material-alert>
          </v-card-text>
        </v-card>
      </v-col>
      <v-col cols="12" md="6">
        <v-card>
          <v-card-text>
            ...
            <base-material-alert
              ...
              dismissible
            >
              <span class="text-uppercase" v-text="color" />
          ...
          <v-card-text class="text-center">
            ...
            <v-row class="mt-n12" justify="center">
              <v-col cols="10" lg="8">
                <v-row>
                  <v-col cols="4">
                    <v-btn color="secondary" default rounded @click="dialog = true">Classic Dialog</v-btn>
                  </v-col>
                  <v-col cols="4">
                    <v-btn color="info" default rounded @click="dialog2 = true">Notice Modal</v-btn>
                  </v-col>
                  <v-col cols="4">
                    <v-btn
                      color="pink darken-1"
    ...
    >
      Welcome to
      <span class="font-weight-bold">&nbsp;MATERIAL DASHBOARD&nbsp;</span> — a beautiful admin panel for every web developer.
    </base-material-snackbar>
          ...
          <v-row>
            <v-col cols="12" md="8">
              <div>
                ...
                <div
                  class="grey--text"
                >The first step is to create an account at Creative Tim. You can choose a social network or go for the classic version, whatever works best for you.</div>
              </div>
            </v-col>
            ...
            <v-col cols="12" md="8">
              <div>
                ...
                <div class="grey--text">
                  ...
                  >Creative Tim</a>. You can choose a social network or go for the classic version, whatever works best for you.
                </div>
              </div>
            </v-col>
            <v-col class="hidden-sm-and-down" md="4">
            ...
            <v-col
              cols="12"
            >If you have more questions, don't hesitate to contact us or send us a tweet @creativetim. We're here to help!</v-col>
          </v-row>
...
export default class DashboardNotifications extends Vue {
  ...
  private direction: string = "top center";
  ...
  private colors: Array<String> = ["info", "success", "warning", "error"];
