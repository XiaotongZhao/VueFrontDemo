        ...
        <base-material-card>
          <template v-slot:heading>
            <v-tabs v-model="tabs" background-color="transparent" slider-color="white">
              <span class="subheading font-weight-light mx-3" style="align-self: center">منتصف:</span>

              <v-tab class="mr-3">
                <v-icon class="me-2">mdi-bug</v-icon>ضرب
              </v-tab>

              <v-tab class="mr-3">
                <v-icon class="me-2">mdi-code-tags</v-icon>السفن
              </v-tab>

              <v-tab>
                <v-icon class="me-2">mdi-cloud</v-icon>فصل.
              </v-tab>
            </v-tabs>
          </template>
                ...
                >
                  <template v-slot:activator="{ attrs, on }">
                    <v-btn v-bind="attrs" :color="timeline.action" large rounded v-on="on">
                      ...
                      <v-icon right>{{ menu ? 'mdi-menu-up' : 'mdi-menu-down' }}</v-icon>
                    </v-btn>
                  </template>
