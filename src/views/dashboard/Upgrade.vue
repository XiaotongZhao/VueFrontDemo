      ...
      <v-col cols="12" md="8">
        <base-material-card color="primary">
          <template v-slot:heading>
            <div class="display-2 font-weight-light">Vuetify Material Dashboard</div>

            <div
              class="subtitle-1 font-weight-light"
            >Are you looking for more components? Please check our Premium Version of Vuetify Material Dashboard</div>
          </template>
          ...
          <v-simple-table>
            ...
            <tbody class="text-center">
              <tr>
                <th class="text-left font-weight-light subtitle-1">Components</th>
                <td>60</td>
                <td>200</td>
              </tr>
              <tr>
              ...
              <tr>
                <th class="text-left font-weight-light subtitle-1">Example Pages</th>
                <td>3</td>
                <td>8</td>
              </tr>
              <tr>
              ...
              <tr>
                <th class="text-left font-weight-light subtitle-1">Premium Support</th>
                <td>
                  <v-icon color="error">mdi-close</v-icon>
                </td>
                <td>
